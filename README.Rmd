...
ggsave(filename = "figures/dosing_3.png", plot = dosing_3, height = 12, width = 9, units = "in")
...
ggsave(filename = "figures/dosing_sum.png", plot = dosing_sum, height = 12, width = 9, units = "in")
```
