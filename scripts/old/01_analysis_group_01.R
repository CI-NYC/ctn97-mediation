...
dat <- readRDS(here::here("data/analysis_data/analysis_data_alt_shift.rds")) |>
  ...
  mutate(
    Group_1 = case_when(dose_total_clonidine_1 >= 0.1 & dose_total_clonazepam_and_benzo_1 >= 2 & max_cows_eligible_1 == 1 ~ 2,
                        dose_total_clonidine_1 >= 0.1 | dose_total_clonazepam_and_benzo_1 >= 2 & max_cows_eligible_1 == 1 ~ 1,
                        TRUE ~ 0),
    Group_2 = case_when(is.na(adj_2) ~ as.numeric(NA),
                        ...
                        dose_total_clonidine_2 >= 0.1 | dose_total_clonazepam_and_benzo_2 >= 2 & max_cows_eligible_2 == 1 ~ 1,
                        TRUE ~ 0),
    Group_3 = case_when(is.na(adj_3) ~ as.numeric(NA),
                        ...
                        dose_total_clonidine_3 >= 0.1 | dose_total_clonazepam_and_benzo_3 >= 2 & max_cows_eligible_3 == 1 ~ 1,
                        TRUE ~ 0),
    Group_4 = case_when(is.na(adj_4) ~ as.numeric(NA),
                        ...
                        dose_total_clonidine_4 >= 0.1 | dose_total_clonazepam_and_benzo_4 >= 2 & max_cows_eligible_4 == 1 ~ 1,
                        TRUE ~ 0),
    Group_5 = case_when(is.na(adj_5) ~ as.numeric(NA),
                        ...
                        dose_total_clonidine_5 >= 0.1 | dose_total_clonazepam_and_benzo_5 >= 2 & max_cows_eligible_5 == 1 ~ 1,
                        TRUE ~ 0)  
  )
...
for (x in c(1))
{
  for (y in c(0))
  {
    ...
    for (i in 14:14) 
    {
      ...
      saveRDS(res, here::here(paste0("results_061725/mediation_", x, "_", y, "_", i, "group_clonidine_01_benzos_3.rds")))
    }
  }
}