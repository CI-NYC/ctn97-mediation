...
for (s in c(1:1)){
  ...
  for (i in c(1))  
  {
    ...
    saveRDS(tmle_de, paste0("results_medoutcon_R1/tmle_de_learners_", learners_txt, "_seed_", s, "_", i, "_benzo_and_clon_M.rds"))
    saveRDS(tmle_ie, paste0("results_medoutcon_R1/tmle_ie_learners_", learners_txt, "_seed_", s, "_", i, "_benzo_and_clon_M.rds"))
    saveRDS(df, paste0("results_medoutcon_R1/res_learners_", learners_txt, "_seed_", s, "_", i, "_benzo_and_clon_M.rds"))
  }
}